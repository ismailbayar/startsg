<?php /* Smarty version 2.6.20, created on 2017-09-17 13:12:45
...
"><?php echo $this->_tpl_vars['user_data']['name']; ?>
				...
				<?php if ($this->_tpl_vars['user_data']['channel_verified'] == 1 && @_MOD_SOCIAL): ?><a href="#" rel="tooltip" title="<?php echo $this->_tpl_vars['lang']['verified_channel']; ?>
...
/img/ico-verified.png" /></a><?php endif; ?>
				...
				<?php if ($this->_tpl_vars['user_data']['is_following_me']): ?>
					<span class="label pm-follows"><?php echo $this->_tpl_vars['lang']['subscriber']; ?>
</span>
				<?php endif; ?>               
				<?php endif; ?>                
                </span>
