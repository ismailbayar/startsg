...
$db_pass = 'I;RcAN.288Pe';

/** MySQL hostname */
$db_host = '185.181.210.253';

$bugisite = explode(".",$_SERVER['SERVER_NAME'])[0];
// Full URL without any trailing slash (e.g http://www.example.com)
define('_URL', "http://".$_SERVER['SERVER_NAME']);	

define('_bugi1', strrev($bugisite));	
define('_bugi2', $bugisite);
//-- Customer ID --//
...
define('_CUSTOMER_ID', '12345scriptnull');	
